...
export function ensureSeed() {
  ...
  const sup1: Supplier = {
    id: id(),
    companyName: "EcoTransportadora Ltda.",
    cnpj: "12.345.678/0001-90",
    email: "contato@ecotransporte.com",
    phone: "(11) 98888-1010",
    address: "Av. das Flores, 1200 — São Paulo/SP",
  ...
  const sup2: Supplier = {
    ...
    cnpj: "12.345.678/0001-90",
    email: "compliance@verdelogistica.com",
    phone: "(21) 97777-2020",
    address: "Av. das Flores, 1200 — Rio de Janeiro/RJ",
    contactName: "Rafael Costa Oliveira",
  ...
  const sup3: Supplier = {
    id: id(),
    companyName: "BioLogistic Express",
    cnpj: "12.345.678/0001-90",
    email: "ana@biologistic.com",
    phone: "(31) 96666-3030",
    address: "Av. das Flores, 1200 — Belo Horizonte/MG",
    contactName: "Ana Beatriz Souza",
